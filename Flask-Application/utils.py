...
def upload_user(
    email: str, metamask_wallet: str, password: str, wallet_address: str, private_key: str
) -> bool:
        ...
        for node_name in ["node_a", "node_b", "node_c"]:
            ...
            for user in node_users:
                ...
                if user_id not in users:
                    users[user_id] = {
                        "email": user["email"],
                        "metamask_wallet": user["metamask_wallet"],
                    ...
                    decrypted_users.append(
                        {
                            ...
                            "Metamask Wallet": user_data["metamask_wallet"],
...
def get_token_by_contract_address(contract_address: str) -> Dict:
    """Fetch a specific token based on its symbol."""
    try:
        filter_dict = {"contract_address": contract_address}
